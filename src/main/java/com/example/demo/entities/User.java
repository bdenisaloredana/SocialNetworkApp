...
public class User extends Entity<Long> {
    ...
    public boolean equals(Object obj){
        ...
        if(!(obj instanceof User))
            return false;
        User user = (User)obj;
        return Objects.equals(getAge(), user.age) && Objects.equals(getFirstName(), user.getFirstName()) && Objects.equals(getLastName(), user.lastName) && Objects.equals(getId(), user.getId());
