...
public class MessageDbRepository {
        ...
        try (Connection connection = DriverManager.getConnection(url, dbUser, dbPassword);
            ...
            try (ResultSet resultSet = ps.executeQuery()) {
                while (resultSet.next()) {
                    ...
                    return new Message(id, idSender, idReceiver, message, date.toLocalDateTime());
                }
            }
    ...
    public List<Message> findAll() {
        ...
        try (Connection connection = DriverManager.getConnection(url, dbUser, dbPassword);
            ...
            while (resultSet.next()) {
                ...
                Long idReceiver = resultSet.getLong("id_receiver");
                Timestamp date = resultSet.getTimestamp("date");
                String messageText = resultSet.getString(resultSet.getString("message"));

                Message message = new Message(id, idSender, idReceiver, messageText, date.toLocalDateTime());
    ...
    public Message update(Message message) {
        ...
        Message dbMessage = findOne(message.getId());
